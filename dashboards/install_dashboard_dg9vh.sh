...
git clone https://github.com/dg9vh/MMDVMHost-Dashboard.git /home/pi/Applications/MMDVMHost-Dashboard
sleep 5
...
sudo cp /home/pi/Applications/MMDVMHost-Dashboard/* /var/www/html/
sleep 5
#Set Permissions
